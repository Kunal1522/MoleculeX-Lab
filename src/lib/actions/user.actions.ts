...
//step->db connect->check for same user->if not prsent
//then hash the recived password->use create fn of db of schema type User to create 
//then finally send verfication mail
//how does this verifcation url work
//first it import verficationurl from email action 
//now this verification url post a request to api/verficartion api made by me 
//finally that sends to resend.com to send mail 
